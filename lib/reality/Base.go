...
func BaseCreate(t Team, baseType int, ipAddress string, ipPort int, randomNameScanner *bufio.Scanner, l Location) Base {
	...
	if IPv4Check(ipAddress) {
		...
		base := Base{name: str, baseType: baseType, ipAddress: ipAddress, ipPort: ipPort, loca: l}
		return base
	}
	return base
}
