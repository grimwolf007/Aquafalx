...
//BaseCreate : creates a base, if you add a non-nil scanner it will use it to get a name rather than use the name you give it.
func BaseCreate(t *Team, baseType int, ipAddress string, ipPort int, l Location, name string, randomNameScanner *bufio.Scanner) Base {
	//if there is a name given use it
	if randomNameScanner != nil {
		name = GetBaseName(randomNameScanner)
	}
	...
	// ipPort is generated by random list separated by type
	var base Base
